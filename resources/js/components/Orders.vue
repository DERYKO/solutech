                            ...
                            <div class="col-lg-8">
                                <div class="c-field ">
                                    ...
                                    <div class="c-field input-group u-mb-xsmall">
                                        <input type="search" v-model="order_number" id="role-name" placeholder="Order Number"
                                               name="order_number" required="required" autocomplete="off" class="c-input"></div>
                                    <!---->
                                </div>
                            </div>
                            <div class="col-lg-8">
            ...
            <table class="c-table">
                ...
                <tr class="c-table__row" >
                    ...
                    <td class="c-table__cell"><span
                            class="c-badge c-badge--success u-text-uppercase c-badge--small">{{order.created_at}}</span>
                    </td>
                    <td class="c-table__cell u-float-right">
                        <router-link class="c-btn c-btn--secondary"  :to="{ name: 'app.order.edit', params: { order : order } }">
                            Edit/View
                        </router-link>
